...
Revision ID: 0370646c91d9
Revises: 
Create Date: 2024-10-24 14:13:03.498917
...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('WITHDRAWAL_TRON', 'WITHDRAWAL_TON', 'SWAP', 'BUY', 'SELL', name='feetype'), nullable=False),
