...
Revision ID: 0b6c39a32513
Revises: 
Create Date: 2024-10-28 14:49:01.174982
...
def upgrade() -> None:
    ...
    sa.Column('action', sa.Enum('BUY', 'SELL', name='marketaction'), nullable=False),
    ...
    op.create_table('users_nft_deposits',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.BIGINT(), nullable=False),
    sa.Column('nft_name', sa.String(), nullable=False),
    sa.Column('nft_address', sa.String(), nullable=False),
    ...
    op.create_table('users_nft_withdrawals',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.BIGINT(), nullable=False),
    sa.Column('nft_name', sa.String(), nullable=False),
    sa.Column('nft_address', sa.String(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table('users_nft_withdrawals')
    op.drop_table('users_nft_deposits')
